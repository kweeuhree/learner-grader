...
function validInput() { // calls createLearner() and prints all Learner instances to console
    ...
    return Learner.getAllInstances();
}
...
function openSampleData() {
    let sampleDataHidden = document.querySelector('.sample-data-hidden');

    let computedStyle = window.getComputedStyle(sampleDataHidden);


    if(computedStyle.display === 'none') {
        sampleDataHidden.style.display = 'flex';
    } else {
        sampleDataHidden.style.display = 'none';
    }
}
